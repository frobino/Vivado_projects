...
################################################################
# This is a generated script based on design: microblaze_system_1
#
...
# source microblaze_system_1_script.tcl
...
set design_name microblaze_system_1
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.NUM_MI {1}  ] $microblaze_0_axi_periph
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_ports Clk] [get_bd_pins mdm_1/S_AXI_ACLK] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_Clk_100M/slowest_sync_clk]
